...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "react-router-dom": async () => {
          let pkg = await import("__mf__virtual/territoriesApp__prebuild__react_mf_2_router_mf_2_dom__prebuild__.js")
          return pkg
        }
      ,
        "react": async () => {
          let pkg = await import("__mf__virtual/territoriesApp__prebuild__react__prebuild__.js")
          return pkg
        }
      ,
        "react-leaflet": async () => {
